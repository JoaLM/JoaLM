...
**Engineering & Program Manager | CAPEX · Digital Transformation · AI**
...
- KPI tracking: PUE, SLA, uptime, power capacity

### ⚡ Energy Optimisation & Price Forecasting *(in progress)*
Applying ML to energy market problems:
- Energy consumption optimisation modelling
- Price forecasting for industrial operations
- Trade optimisation scenarios
...
Analytics     Anomaly Detection · Time Series · Statistical Modelling
Dev Tools     VS Code · GitHub Copilot · Claude Code
Protocols     SNMP · Redfish API · DCIM
```
